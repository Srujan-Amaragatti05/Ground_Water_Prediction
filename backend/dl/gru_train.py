...
model.add(
    GRU(
        units=50,                # same capacity as LSTM
        activation="tanh",
...
print(f"GRU RMSE: {rmse:.3f}")
print(f"GRU MAE : {mae:.3f}")
...
plt.plot(y_pred[:200], label="GRU Predicted WL")
plt.title("GRU: Actual vs Predicted Groundwater Level")
...
# -----------------------------
model.save("gru_groundwater_model.h5")
print("GRU model saved as gru_groundwater_model.h5")
